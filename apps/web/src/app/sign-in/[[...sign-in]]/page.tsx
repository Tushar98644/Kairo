...
const SignInPage = () => {
  return (
    <div className="flex h-screen w-screen items-center justify-center text-sm py-20">
                      ...
                      <TextureCardStyled>
                        ...
                        <TextureCardContent>
                          ...
                          <Clerk.Field name="identifier" className="space-y-2">
                            ...
                            <Clerk.Input type="email" required asChild>
                              <Input className="w-full px-4 py-4 rounded-md border border-neutral-300 dark:border-neutral-700 bg-white/80 dark:bg-neutral-800/80 placeholder-neutral-400 dark:placeholder-neutral-500" />
                            </Clerk.Input>
                        ...
                        <TextureCardFooter className="border-b rounded-b-sm">
                          <SignIn.Action submit asChild>
                            <Button variant="secondary" className="w-full" disabled={isGlobalLoading}>
                              <Clerk.Loading>
                                {(isLoading) => {
                                  return isLoading ? (
                    ...
                    <SignIn.Step name="choose-strategy">
                      <TextureCardStyled>
                        <TextureCardHeader className="flex flex-col gap-1 items-center justify-center p-4">
                          ...
                          <TextureCardTitle>Use another method</TextureCardTitle>
                          <p className="text-center">
                        ...
                        <TextureCardContent>
                          <div className="grid gap-y-4">
                            <SignIn.SupportedStrategy name="email_code" asChild>
                              <Button type="button" variant="outline" disabled={isGlobalLoading}>
                                Email code
                              </Button>
                      ...
                      <SignIn.Strategy name="password">
                        <TextureCardStyled>
                          <TextureCardHeader className="flex flex-col gap-1 items-center justify-center p-4">
                            ...
                            <TextureCardTitle>Enter your password</TextureCardTitle>
                            <p className="text-center">
