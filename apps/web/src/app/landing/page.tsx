  ...
  return (
    <div className="flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="w-full py-2 md:py-0 lg:py-0 overflow-hidden">
          <div className="px-4 md:px-6 relative">
            ...
            >
              <Badge className="mb-4 mt-20 rounded-full px-4 text-sm font-medium" variant="secondary">
                Launching Soon
              </Badge>
      ...
      <footer className="w-full border-t bg-background/95 backdrop-blur-sm">
        <div className="flex flex-col gap-8 px-4 py-10 md:px-6 lg:py-16">
          ...
          <div className="flex flex-col px-6 gap-4 sm:flex-row justify-between items-center border-t border-border/40 pt-8">
