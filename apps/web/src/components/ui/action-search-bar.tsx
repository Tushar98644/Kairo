...
function ActionSearchBar({
            ...
            switch (e.key) {
                ...
                case "Enter":
                    ...
                    if (activeIndex >= 0 && result.actions[activeIndex]) {
                        ...
                        // You might want to close the dropdown here
                        // setIsFocused(false);
                    }
                    break;
                case "Escape":
    ...
    const handleBlur = useCallback(() => {
        // Delay blur to allow click events on the dropdown to register
        setTimeout(() => {
            setIsFocused(false);
            setActiveIndex(-1);
        }, 200);
                ...
                <div>
                    <div className="relative">
                        <Input
                            ...
                            id="search"
                            autoComplete="off"
                            className="w-full pl-3 pr-9 py-1.5 h-9 text-sm rounded-lg focus-visible:ring-offset-0"
                        />
