  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]:min-h-[calc(100svh-(--spacing(4)))] md:peer-data-[variant=inset]:rounded-s-2xl md:peer-data-[variant=inset]:shadow-[0_0_0_1px_var(--border)] md:peer-data-[state=collapsed]:rounded-s-none! transition-[border-radius] duration-200 ease-in-out",
        className,
      )}
      {...props}
    />
